...
use langchain_openai::{OpenAICompatibleChatModel, OpenAICompatibleEmbeddings};
...
impl BaseChatModel for ChatMistralAI {
...
impl Embeddings for MistralAIEmbeddings {
